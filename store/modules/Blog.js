...
const getters = {
    currentArticleID: (_state) => _state[_state.articleID],
    currentCategory: (_state) => _state[_state.currentCategory],
};
const mutations = {
    CHANGE_ARTICLE(_state, _id) {
        _state.currentAlbumName = _id;
    },
